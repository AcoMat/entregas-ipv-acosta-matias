...
func enter() -> void:
	...
	$SwordAudio.stream = preload("res://assets/sound/sfx/attacks/sword/26_sword_hit_2.wav")
...
func _on_CutArea_body_entered(body: Node) -> void:
	if body.has_method("notify_hit"):
		...
		$SwordAudio.stream = preload("res://assets/sound/sfx/attacks/sword/26_sword_hit_1.wav")
		$SwordAudio.play()
